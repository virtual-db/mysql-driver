...
// replace directives: remove once modules are published to a module proxy.
replace github.com/AnqorDX/vdb-core => ../vdb-core

replace github.com/AnqorDX/dispatch => ../dispatch
