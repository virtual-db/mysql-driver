...
func ToGMSSchema(table string, cols []ColumnDescriptor) gmssql.Schema {
...
func columnTypeToGMS(col ColumnDescriptor) gmssql.Type {
...
// defensively.
func charLength(col ColumnDescriptor, fallback int64) int64 {
