...
import (
	...
	intschema "github.com/AnqorDX/vdb-mysql-driver/internal/schema"
...
// found it constructs and returns a Table. Any schema error is treated as
// "table does not exist" from GMS's perspective (returns nil, false, nil).
